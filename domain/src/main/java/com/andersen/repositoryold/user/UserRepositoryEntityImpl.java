...
public class UserRepositoryEntityImpl implements UserRepository {
    ...
    public UserRepositoryEntityImpl(UserRepository userDAO1) {
    ...
    public void registerCustomer(User user) throws SQLException {
        ...
        try {
            userDAO.registerCustomer(user); // Create user using DAO
    ...
    public User getUserByUsername(String username) throws SQLException {
        return userDAO.getUserByUsername(username); // Fetch user by username
    }
}