...
public class BookingServiceImpl implements BookingService {
    ...
    public Booking createBooking(User customer, Long workspaceId, LocalDate date,
        ...
        try {
            ...
            if (!bookingRepository.isWorkspaceAvailable(workspaceId, date.atStartOfDay(), startTime, endTime)) {
                throw new BookingServiceException("Workspace already booked for this time");
            }
    ...
    /**
     * Cancels a booking if it belongs to the requesting user.
     *
     * @param bookingId ID of the booking to cancel
     * @param userId ID of the user requesting cancellation
     * @return true if cancellation was successful, false if booking was already cancelled
     * @throws BookingServiceException if parameters are invalid, booking not found,
     *         unauthorized attempt, or data access error occurs
     */
    @Override
    ...
    /**
     * Finds all available workspaces for a given time period.
     *
     * @param date date to check availability
     * @param startTime start time of desired booking period
     * @param endTime end time of desired booking period
     * @return list of available workspaces (empty list if none available)
     * @throws BookingServiceException if time parameters are invalid or data access error occurs
     */
    @Override
    ...
    /**
     * Validates all booking creation parameters.
     *
     * @param customer booking user (must not be null)
     * @param workspaceId workspace ID (must not be null)
     * @param date booking date (must be today or future)
     * @param startTime start time (must be before endTime)
    ...
    /**
     * Validates time-related parameters for bookings.
     *
     * @param date booking date
     * @param startTime start time
     * @param endTime end time
     * @throws BookingServiceException if parameters are null, time range is invalid,
    ...
    /**
     * Calculates the total price for a booking based on workspace hourly rate.
     *
     * @param workspace the booked workspace
